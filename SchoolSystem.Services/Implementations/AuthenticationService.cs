...
namespace SchoolSystem.Services.Implementations
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(UserManager<User> userManager, IEmailsService emailsService, ApplicationDbContext context = null, JwtSettings jwtSettings = null, IRefreshTokenRepository refreshTokenRepository = null)
        {
